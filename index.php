 ...
 <!--Loop category-->
   ...
   <div class="card">
     <figure class="figure">
       ...
       <figcaption class="figure-caption text-center"><a href='categories/category.php?cat_id=<?=$data['id'];?>&&cat_name=<?=$data['cat_name'];?>' class="stretched-link">category : <?=$c." : ".$data[$c-1]?></a></figcaption>
     </figure>
   </div> 
  <? $c++;} ?>
      </div> 
